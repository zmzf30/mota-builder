...
打开 `http://127.0.0.1:8765/` 后，可以在页面里确认规模、填写基础参数、开始整塔生成；高级选项里可以查看完整提示词，也可以继续上次未完成生成。生成中可终止并清理本次产物，生成后可直接试玩、打开编辑器或导出 `project.zip`。这个 UI 不需要 Node.js。
...
- 生成阶段会分为怪物数据设计、拓扑、经济、怪物特殊能力、审查和修复。
